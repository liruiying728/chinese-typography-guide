...
排版的灵魂不仅仅在于字符间的呼吸感，更在于其在多语言系统中的严谨性与兼容性。本文档将从以下维度展开：

1. 视觉节奏：空格的使用与文字格式；
2. 符号规范：标点符号的正确选择与避头尾禁则；
3. 文本质量：正确书写、准确表达、约定俗成的用法辨析；
4. 工程实现：双向文本处理与逻辑属性的应用。
...
带贝字旁的文字一般都是与金钱有关，因为贝壳在古代有银钱的意思，如：赔、贩、财、购、贿、资。当指和钱财相关的记载时，「帐」和「账」是通用的。

在互联网中的应用中，帐号表示数字「账户」。

所以可以这么简单记忆：遇到跟金钱有关的使用「账户」，其他的互联网相关的使用「帐户」。
...
![](./vertical-short-western-text-not-recommended.jpg)

![](./vertical-long-western-text-not-recommended.jpg)
...
![](./vertical-short-western-text-recommended.jpg)

![](./vertical-long-western-text-recommended.jpg)
...
![](./vertical-numbers-handling-not-recommended.jpg)

🔵 推荐（纵中横，横向紧排）

![](./vertical-numbers-handling-recommended.jpg)
